...
def readExcel(inputUniformedBits, inputDatasetLength):
    # Initialization - Read Excel Document
    book  = openpyxl.load_workbook('Datasets_Uniformed_{}.xlsx'.format(inputUniformedBits))
    sheet = book.active
